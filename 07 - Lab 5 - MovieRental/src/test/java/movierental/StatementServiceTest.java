...
public class StatementServiceTest {
	...
	public void statementForRegularMovie() {
		...
		Customer customer2 = new CustomerBuilder().withName("Sallie").withRentals(rental1).build();
		String expected = "Rental Record for Sallie\n" + "\tGone with the Wind\t3.5\n" + "Amount owed is 3.5\n"
				+ "You earned 1 frequent renter points";
		String statement = StatementService.buildStatement(customer2);
	...
	public void statementForManyMovies() {
		...
		Customer customer1 = new CustomerBuilder().withName("David").withRentals(rental1, rental2, rental3).build();
		String expected = "Rental Record for David\n" + "\tMadagascar\t6.0\n" + "\tStar Wars\t6.0\n"
				+ "\tGone with the Wind\t11.0\n" + "Amount owed is 23.0\n" + "You earned 4 frequent renter points";
		String statement = StatementService.buildStatement(customer1);
		assertThat(statement).isEqualTo(expected);
	}
}
